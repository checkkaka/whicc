...
final class LangConfig: ObservableObject {
    ...
    func setNemotronRightContext(_ value: Int) {
        nemotronRightContext = [3, 6, 13].contains(value) ? value : 6
        save()
    }
    ...
    private func save() {
        ...
        json["translation_priority_enabled"] = translationPriorityEnabled
        json["probe_partial_enabled"] = probePartialEnabled
        json["nemotron_native_streaming_enabled"] = nemotronNativeStreamingEnabled
